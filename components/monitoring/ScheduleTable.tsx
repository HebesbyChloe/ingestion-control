            ...
            >
              <TableCell>
                <div>
                  ...
                  <div className="text-xs text-slate-500 font-mono">{schedule.cron_expression}</div>
                </div>
              </TableCell>
              <TableCell>
                <Badge
              ...
              <TableCell>
                <Badge variant="outline" className={cn(getErrorColor(schedule.error_rate))}>
              ...
              <TableCell className="font-mono text-slate-900">{schedule.run_count}</TableCell>
              <TableCell className="font-mono text-red-600">{schedule.error_count}</TableCell>
              <TableCell className="text-sm text-slate-600">{schedule.target_service}</TableCell>
